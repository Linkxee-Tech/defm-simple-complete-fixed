...
async def create_evidence(
    ...
    logger.info(f"Evidence created: {db_evidence.evidence_number} by {current_user.username}")
    return db_evidence
...
async def upload_evidence_file(
    ...
    try:
        ...
        upload_dir = os.path.join(settings.UPLOAD_DIRECTORY, str(evidence.case_id), str(evidence_id))
        ...
        logger.info(f"File uploaded: {file.filename} for evidence {evidence.evidence_number} by {current_user.username}")
...
async def update_evidence(
    ...
    logger.info(f"Evidence updated: {db_evidence.evidence_number} by {current_user.username}")
    return db_evidence
...
async def delete_evidence(
    ...
    logger.info(f"Evidence deleted: {evidence_number} by {current_user.username}")
